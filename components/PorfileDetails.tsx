    ...
    <div className='container mx-auto bg-zinc-900/30 w-11/12 sm:w-9/12 md:w-7/12 rounded-md flex flex-col-reverse my-16 py-10 px-8 justify-between md:flex-row md:items-center'>
      <div className='md:w-8/12'>
        <div className='space-y-2'>
          <h1 className='text-2xl font-semibold'> Selam Ben, <span className='text-2xl font-semibold text-violet-500 hover:opacity-75 cursor-pointer'>@ragnar054</span> </h1>
                ...
                <div className='truncate hover:text-clip'>
                  <div>
                    <div className='text-zinc-300 break-words mx-2 select-none leading-tight'>
                      <p> <b>{discord.data.spotify.song}</b> dinliyor. <b>{discord.data.spotify.artist.includes(';') ? discord.data.spotify.artist.split(';')[0] : discord.data.spotify.artist}</b></p>
                    </div>
                  </div>
                </div>
              </>
            ...
            {discord && discord.data && discord.data['activities'].find((data) => data.name === 'Visual Studio Code') ? (
              <>
                ...
                <div className='truncate hover:text-clip'>
                  <div>
                    <div className='text-zinc-300 break-words mx-2 select-none leading-tight'>
                      <p> <b>{discord.data['activities'].find((data) => data.name === 'Visual Studio Code')?.details}</b> Çalışıyor.</p>
                    </div>
                  </div>
                </div>
              </>
      ...
      <div className='avatar'>
        {discord ? (
          ...
          <div className={'w-36 rounded-full mb-4 md:mb-0 ring ring-primary ring-offset-base-100 ring-offset-2'}>
            <Image className='rounded-full hover:opacity-75 transition duration-700' src={'https://cdn.discordapp.com/attachments/1154444966429462578/1251213867993006090/1402072019322591028550524.jpg?ex=666dc338&is=666c71b8&hm=63141524ef9ad05011be00e22c0cb1a573744f99a7cd12ce254eb9909f7db063&'} alt='avatar' width={1024} height={1024} />
          </div>
        )}
      </div>
    </div>
